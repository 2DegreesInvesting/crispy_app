...
semanticPage(
  ...
  tags$div(class = "ui raised very padded text container segment",
      tags$div(class = "ui huge header", "CRISPY"),

      tags$div(class = "ui two cards",
          tags$div(class = "card",
      ...
      tags$table(class = "ui celled table",
          tags$thead(
            tags$tr(
              tags$th("Name"),
              tags$th("Description"),
      ...
      tags$div(class = "ui two column very relaxed grid",
